...
public class MiniCardListResult {
	...
	public String msg;
	@SerializedName("info")
	private ArrayList<MiniCard> infos;


	@Override
	public String toString() {
		return "MiniCardListResult [state=" + state + ", total=" + total
	...
	public ArrayList<MiniCard> getInfos() {
		return infos;
	}

	public void setInfos(ArrayList<MiniCard> infos) {
		this.infos = infos;
	}
